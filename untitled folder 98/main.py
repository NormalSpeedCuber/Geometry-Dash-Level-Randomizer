...
def get_level():
    difficulties = ["Easy", "Normal", "Hard", "Harder", "Insane", "Easy Demon", "Medium Demon", "Hard Demon", "Insane Demon", "Extreme Demon"]
    difficulty = random.choice(difficulties)

    
    page = random.randint(1, 1000) if difficulty == "Insane" else \
           random.randint(1, 199) if difficulty == "Easy Demon" else \
           random.randint(1, 217) if difficulty == "Medium Demon" else \
           random.randint(1, 151) if difficulty == "Hard Demon" else \
           random.randint(1, 108) if difficulty == "Insane Demon" else \
